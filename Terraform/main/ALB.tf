# Service group for the LB
# World accessible for HTTP
...
resource "aws_lb" "external-alb" {
  ...
  subnets            = [module.vpc.LB_SUB1_id, module.vpc.LB_SUB2_id]
}

# Target group with definition of my custom application port
